...
const ProjectBudget = () => {
  ...
  return (
    <Layout>
    <Grid container spacing={2} justifyContent="center"xs={10}  sx={{ marginLeft: 'auto', marginRight: 'auto' }}>
      <Grid item xs={10}>
            ...
            <TableBody>
              {projectBudget.map((budget) => (
                <TableRow key={budget._id}>
                  ...
                  <TableCell>
                    <Button color="primary" onClick={() => handleEdit(budget._id)}>
                      Edit
                    </Button>
                  </TableCell>
                  <TableCell>
                    <Button color="error" onClick={() => handleDelete(budget._id)}>
                      Delete
                    </Button>
                  </TableCell>
        ...
        <DialogContent>
          <form>
            ...
            <TextField
              ...
              onChange={(e) =>
                setEditFormData({ ...editFormData, budgetedHours: e.target.value })
              }
              fullWidth
              sx={{ mb: 2 }}
            />

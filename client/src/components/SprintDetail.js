...
const SprintDetailComponent = () => {
  ...
  const handleEdit = (id) => {
    const sprintDetailToEdit = sprintDetails.find((detail) => detail._id === id);
    setEditItemId(id);
    setEditFormData({
            ...
            <TableBody>
              {sprintDetails.map((detail) => (
                <TableRow key={detail._id}>
                  ...
                  <TableCell>
                    <Button color="primary" onClick={() => handleEdit(detail._id)}>
                      Edit
                    </Button>
                  </TableCell>
                  <TableCell>
                    <Button color="error" onClick={() => handleDelete(detail._id)}>
                      Delete
                    </Button>
                  </TableCell>
                </TableRow>

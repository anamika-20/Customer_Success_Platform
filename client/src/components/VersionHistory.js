            ...
            <TableBody>
              {versionHistory.map((history) => (
                <TableRow key={history._id}>
                  ...
                  <TableCell>{history.revisionDate.split("T")[0]}</TableCell>
                  <TableCell>{history.approvalDate.split("T")[0]}</TableCell>
  ...
  <DialogContent>
    <form onSubmit={handleSaveEdit}>
      <TextField
        ...
        onChange={(e) =>
          setEditFormData({ ...editFormData, versionNumber: e.target.value })
        }
        fullWidth
        sx={{ mb: 2 }}
      />
      ...
      <TextField
        ...
        onChange={(e) =>
          setEditFormData({ ...editFormData, change: e.target.value })
        }
        fullWidth
        sx={{ mb: 2 }}
      />
      ...
      <TextField
        ...
        onChange={(e) =>
          setEditFormData({ ...editFormData, createdBy: e.target.value })
        }
        fullWidth
        sx={{ mb: 2 }}
      />
      <TextField
        ...
        onChange={(e) =>
          setEditFormData({ ...editFormData, revisionDate: e.target.value })
        }
        fullWidth
        sx={{ mb: 2 }}
      />
      <TextField
        ...
        onChange={(e) =>
          setEditFormData({ ...editFormData, approvalDate: e.target.value })
        }
        fullWidth
        sx={{ mb: 2 }}
      />
      <TextField
        ...
        onChange={(e) =>
          setEditFormData({ ...editFormData, approvedBy: e.target.value })
        }
        fullWidth
        sx={{ mb: 2 }}
      />

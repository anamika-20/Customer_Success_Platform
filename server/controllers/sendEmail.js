  ...
  try {
    ...
    for (let i = 0; i < emails.length; i++) {
      const mailOptions = {
        ...
        subject: "Audit History", // Subject line
        html: `<b>Hello ${names[i]}, </b> <br/> <p>Please note there's a change in the audit and here is the complete audit details:<p> ${data} <br/>  <br/> <p> Location: <a href="http://localhost:3000/">Customer Success Platform</a></p> <br/> <p>Thanks and Regards,</p><p>
